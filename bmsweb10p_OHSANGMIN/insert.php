    ...
    <body>
		...
		<table align="center" style="width: 950">
			<tr>
				...
				<td style="font-size: x-large; text-align: center; width: 40%">書籍登録</td>
		...
		<form style="align: center" action="insert.php" method="POST">
    		<table align="center" style="text-align: center" border="1">
    			<tr>
    				<td style="text-align: center; width: 100; background-color: blue; color: white">ISBN</td>
    				<td><input style="width: 150" type="text" name="isbn" value=""/></td>
    			</tr>
    			<tr>
    				<td style="text-align: center; width: 100; background-color: blue; color: white">TITLE</td>
    				<td><input style="width: 150" type="text" name="title" value=""/></td>
    			</tr>
    			<tr>
    				<td style="text-align: center; width: 100; background-color: blue; color: white">価格</td>
    				<td><input style="width: 150" type="text" name="price" value=""/></td>
    			</tr>
    		</table>
